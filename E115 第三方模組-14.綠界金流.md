...
## 小結
ODOO原生付款可以開放"電匯"功能，或使用國外的Stripe、PayPal功能，但在台灣使用有所限制，

此次測試與14版本相比，沒有出現什麼錯誤，紀錄如下:
  + 安裝方面，僅更新參數即可使用，
  + 綠界支付方面，使用者端只要選哪些方式進行付款即可。
  + 銷售流程方面，有考慮到收款情況，避免核對沖帳動作。

整體來說，綠界收到款項後，入賬到商家也會有一段時間的差異[參考6]，需根據實際上線的情況，去進行結帳的需求。
...
6. 綠界金流入帳 - [網址](https://support.ecpay.com.tw/4809/)
